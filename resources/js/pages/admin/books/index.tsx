        ...
        <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    form.setData('condition', v as Condition)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <div className="grid gap-2">
              ...
              {editing?.cover_image && (
                <img
                  src={`/storage/${editing.cover_image}`}
                  alt=""
            ...
            {editing?.images && editing.images.length > 0 && (
              <div className="grid gap-2">
                      ...
                      <button
                        ...
                        onClick={() =>
                          form.setData(
                            'deleted_images',
                            marked
                              ? form.data.deleted_images.filter(
                                  (id) => id !== img.id,
                                )
                ...
                <p className="text-xs text-muted-foreground">
                  Klik gambar untuk menandai hapus.
                </p>
              </div>
            )}
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Buku “{deleteTarget?.title}” beserta foto-fotonya akan dihapus
...
Index.layout = {
  breadcrumbs: [{ title: 'Buku', href: '/admin/books' }],
};
